                  ...
                  {editingId === conv.id ? (
                    <div className="flex flex-col gap-2">
                      <input
                        ...
                        autoFocus
                        className="w-full bg-[var(--bg-card)] border border-[var(--border-color)] rounded px-2 py-1.5 text-xs text-[var(--text-primary)] focus:outline-none focus:border-[var(--accent-gold)]"
                      />
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                        ...
                        className="w-full py-1.5 rounded bg-[var(--accent-gold)] text-[var(--bg-primary)] text-xs font-medium"
                      >
                        確認
                      </button>
                    </div>
                    ...
                    <>
                      {/* 標題 */}
                      <p className="text-xs text-[var(--text-primary)] truncate leading-tight mb-1">
                        {conv.title}
                      </p>
                      {/* 訊息數 + 操作按鈕 */}
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            className="p-1 rounded hover:bg-[var(--bg-card)] text-[var(--text-muted)] hover:text-[var(--accent-gold)]"
                            title="編輯"
                          >
                          ...
                          <button
                            ...
                            className="p-1 rounded hover:bg-[var(--bg-card)] text-[var(--text-muted)] hover:text-red-400"
                            title="刪除"
                          >
