...
import { ArrowLeft, BrainCircuit, Construction } from 'lucide-react';
      ...
      <section className="relative overflow-x-hidden border-b border-[var(--border-color)]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-indigo-400 flex items-center justify-center">
